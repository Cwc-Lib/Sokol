...
typedef struct {
    ...
    PFN_wglChoosePixelFormat ChoosePixelFormat;
...
_SOKOL_PRIVATE void _sapp_wgl_load_extensions(void) {
	...
	printf("\nChoosePixelFormat %p ", ChoosePixelFormat);
//hoosePixelFormat(0, 0);
	printf("\nokay");
	
	
	/*
	_sapp.wgl.ChoosePixelFormat(_sapp.wgl.msg_dc, &pfd);
	//_sapp.wgl.ChoosePixelFormat(0, 0);
...
printf("\n main_entry Called\n ");
    ...
    sapp_desc desc = sokol_main(argc_utf8, "");
